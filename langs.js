...
const translationSR = {
    ...
    "sta_radim": "Specijalizujem se u izradi veb-sajtova i desktop aplikacija koji olakšavaju zadatke i poboljšavaju korisnička iskustva.",
...
const translationEN = {
    ...
    "zdr-txt": "Hello, I am",
    "moje-ime": "Filip Grujić",
    "sta_radim": "I specialize in the making of websites and desktop applications that make tasks easier and improve user experiences.",
    "portfolio-title": "PORTFOLIO",
...
const translationRU = {
    ...
    "sta_radim": "Я специализируюсь на разработке веб-сайтов и приложений для ПК, которые упрощают задачи и делают опыт пользователей лучше.",
